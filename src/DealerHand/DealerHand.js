                        ...
                        for (let c = 6; c > 0; c--) {
                            ...
                            for (let d = 5; d > 0; d--) {
                                ...
                                if (imaginaryCount + i + x + y + b + c + d == 17) {
                                    ...
                                    odds19 += (num / iTotal) * (secNum / (iTotal - 1)) * (thirdNum / (iTotal - 2)) * (fourthNum / (iTotal - 3)) * (fifthNum / (iTotal - 4)) * (sixthNum / (iTotal - 5))
                                    continue;
                                } else if (imaginaryCount + i + x + y + b + c == 20) {
                                    odds20 += (num / iTotal) * (secNum / (iTotal - 1)) * (thirdNum / (iTotal - 2)) * (fourthNum / (iTotal - 3)) * (fifthNum / (iTotal - 4)) * (sixthNum / (iTotal - 5))
                                    continue;
                                } else if (imaginaryCount + i + x + y + b + c == 21) {
                                    odds21 += (num / iTotal) * (secNum / (iTotal - 1)) * (thirdNum / (iTotal - 2)) * (fourthNum / (iTotal - 3)) * (fifthNum / (iTotal - 4)) * (sixthNum / (iTotal - 5))
                                    continue;
                                }
                                ...
                                for (let e = 4; e > 0; e--) {
                                    ...
                                    if (imaginaryCount + i + x + y + b + c + d + e == 17) {
                                        ...
                                        odds19 += (num / iTotal) * (secNum / (iTotal - 1)) * (thirdNum / (iTotal - 2)) * (fourthNum / (iTotal - 3)) * (fifthNum / (iTotal - 4)) * (sixthNum / (iTotal - 5)) * (seventhNum / (iTotal - 6))
                                        continue;
                                    } else if (imaginaryCount + i + x + y + b + c == 20) {
                                        odds20 += (num / iTotal) * (secNum / (iTotal - 1)) * (thirdNum / (iTotal - 2)) * (fourthNum / (iTotal - 3)) * (fifthNum / (iTotal - 4)) * (sixthNum / (iTotal - 5)) * (seventhNum / (iTotal - 6))
                                        continue;
                                    } else if (imaginaryCount + i + x + y + b + c == 21) {
                                    ...
                                    for (let f = 3; f > 0; f--) {
                                        ...
                                        if (imaginaryCount + i + x + y + b + c + d + e + f == 17) {
                                            ...
                                            odds18 += (num / iTotal) * (secNum / (iTotal - 1)) * (thirdNum / (iTotal - 2)) * (fourthNum / (iTotal - 3)) * (fifthNum / (iTotal - 4)) * (sixthNum / (iTotal - 5)) * (seventhNum / (iTotal - 6)) * (eightNum / (iTotal - 7))
                                            continue;
                                        } else if (imaginaryCount + i + x + y + b + c + d == 19) {
